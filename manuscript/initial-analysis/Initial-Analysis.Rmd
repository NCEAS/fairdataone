...
```{r}
source(here::here("R", "standardize_theme_modified_ADC.R"))
source(here::here("R", "standardize_colors_shapes.R"))
```


```{r}
#load data directly from KNB
...
DataONE_FAIR_data <- vroom::vroom(fair_data_file)
```
